...
//for (int i = 0; i < iw.length; i++)
  ...
  {
    if (pos.equalsIgnoreCase("N")) return POS.NOUN;
    if (pos.equalsIgnoreCase("V")) return POS.VERB;
    if (pos.equalsIgnoreCase("R")) return POS.ADVERB;
    if (pos.equalsIgnoreCase("A")) return POS.ADJECTIVE;
    return null;
  }
