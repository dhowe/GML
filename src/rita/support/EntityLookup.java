 ...
 * Note: based on code in org.apache.commons.lang
 *
 */// * @TODO. handle &middot;  ??
...
{  
  ...
  private EntityLookup() {
    //System.out.println("EntityLookup<init>");
    this.map = new LookupEntityMap();
    addEntityLookup(BASIC_ARRAY); 
  }
  ...
  private static final String[][] BASIC_ARRAY = {
      ...
      { "middot","183" },  // mid-line period
  };
 
  static void fillWithHtml40EntityLookup(EntityLookup el)
  {
    el.addEntityLookup(BASIC_ARRAY);
    el.addEntityLookup(ISO8859_1_ARRAY);
    el.addEntityLookup(HTML40_ARRAY);
  }
  ...
  public void addEntityLookup(String[][] entityArray)
  {
  ...
  /**
   * <p>Unescapes the EntityLookup in a <code>String</code>.</p> 
   * @param str - The <code>String</code> to escape.
   * @return A new escaped <code>String</code>.
   */
  ...
  static final String[][] ISO8859_1_ARRAY = { 
        ...
        { "raquo", "187" }, // right-pointing double angle quotation mark = rightpointing guillemet
    ...
    // http://www.w3.org/TR/REC-html40/sgml/EntityLookup.html
    // package scoped for testing
    static final String[][] HTML40_ARRAY = {
    // <!-- Latin Extended-B -->
        { "fnof", "402" }, // latin small f with hook = function= florin, U+0192ISOtech -->
        // <!-- Greek -->
        ...
        { "hellip", "8230" }, // horizontal ellipsis = three dot leader,U+2026ISOpub  -->
        ...
        // by' arrowbut also does not have any other character for that function.
        // So ? lArr canbe used for 'is implied by' as ISOtech suggests -->
        { "uArr", "8657" }, // upwards double arrow, U+21D1 ISOamsa -->
        { "rArr", "8658" }, // rightwards double arrow,U+21D2 ISOtech -->
        // <!-- ISO 10646 does not say this is the 'implies' character but does
        // not have another character with this function so ?rArr can be used for
